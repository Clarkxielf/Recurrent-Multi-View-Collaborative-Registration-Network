...
if __name__ == '__main__':
    ...
    paths = os.getcwd() + '/' + arg.train_val_root_path + '/' + arg.test_datasets_mat_path
    ...
    sio.savemat(arg.pcr_dataset_path + f'/pcr_scale_{arg.scale}.mat',
